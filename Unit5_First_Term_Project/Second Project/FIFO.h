...
E_FIFO_RETURN FIFO_enqueue(FIFO_Queue* My_Queue,DataType *item);				//adds one items to FIFO
E_FIFO_RETURN FIFO_dequeue(FIFO_Queue* My_Queue,DataType *store_P);				//pop one item from queue and stores it in address store_P
